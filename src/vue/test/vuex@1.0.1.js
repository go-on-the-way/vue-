...
(function (global, factory) {
    ...
    var override = function (Vue) {
        ...
        function vuexInit() {
            ...
            if (vuex) {
                if (!this.$store) {
                    console.warn('[vuex] store not injected. make sure to ' +
                ...
                if (state && !getters) {
                    console.warn('[vuex] vuex.state option will been deprecated in 1.0. ' +
        ...
        function defineVuexGetter(vm, key, getter) {
            if (typeof getter !== 'function') {
                console.warn('[vuex] Getter bound to key \'vuex.getters.' + key +
                    '\' is not a function.');
            } else {
        ...
        function makeBoundAction(store, action, key) {
            if (typeof action !== 'function') {
                console.warn('[vuex] Action bound to key \'vuex.actions.' + key +
                    '\' is not a function.');
            }
    ...
    var Store = function () {
        ...
        createClass(Store, [{
            ...
            value: function dispatch(type) {
                ...
                for (var _len2 = arguments.length, payload = Array(_len2 > 1 ? _len2 -
                ...
                if ((typeof type === 'undefined' ? 'undefined' : _typeof(type)) ===
                    'object' && type.type && arguments.length === 1) {
                ...
                if (handler) {
                    ...
                    if (Array.isArray(handler)) {
                        handler.forEach(function (h) {
                            isObjectStyleDispatch ? h(state, payload) : h.apply(
                                undefined, [state].concat(toConsumableArray(
                                    payload)));
                        });
                    } else {
                        isObjectStyleDispatch ? handler(state, payload) : handler.apply(
                            undefined, [state].concat(toConsumableArray(payload)));
                    }
                    this._dispatching = false;
                    if (!silent) {
                        (function () {
                            var mutation = isObjectStyleDispatch ? payload : {
                                type: type,
                                payload: payload
                            };
            ...
            value: function _setupModuleMutations(updatedModules) {
                ...
                this._mutations = mergeObjects([this._rootMutations].concat(
                    toConsumableArray(updatedMutations)));
            }
            ...
            value: function _createModuleMutations(modules, nestedKeys) {
                ...
                return Object.keys(modules).map(function (key) {
                    ...
                    // retrieve nested modules
                    var nestedMutations = _this5._createModuleMutations(module.modules,
                        newNestedKeys);
                    ...
                    Object.keys(module.mutations).forEach(function (name) {
                        ...
                        mutations[name] = function (state) {
                            for (var _len3 = arguments.length, args =
                                    Array(_len3 > 1 ? _len3 - 1 : 0),
                                    _key3 = 1; _key3 < _len3; _key3++) {
                                args[_key3 - 1] = arguments[_key3];
                            }

                            original.apply(undefined, [
                                getNestedState(state,
                                    newNestedKeys)].concat(
                                args));
                        };
                    });

                    // merge mutations of this module and nested modules
                    return mergeObjects([mutations].concat(toConsumableArray(
                        nestedMutations)));
                });
            }
